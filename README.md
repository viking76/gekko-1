# THIS IS A TEST and HAVE SOME BUG!!!!!!!!
...
This project is a fork of  [askmike/gekko]( https://github.com/askmike/gekko). I'm working on it to add some strategies and functionalites (maybe, we'll see!)
